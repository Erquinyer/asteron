      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md px-8 py-10">
        ...
        {sent ? (
          <div className="text-center space-y-4">
            ...
            <Link to="/login"
              className="inline-block mt-2 text-sm text-slate-600 hover:text-slate-800 underline underline-offset-2">
              Volver al inicio de sesión
            </Link>
          </div>
        ) : (
          <>
            <h1 className="text-2xl font-bold text-center text-slate-800">¿Olvidaste tu contraseña?</h1>
            ...
            <form onSubmit={handleSubmit} noValidate>
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-lg border border-slate-300 text-sm focus:outline-none focus:ring-2 focus:ring-slate-500"
                />
              </div>
